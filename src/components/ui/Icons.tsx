...
/** The X (formerly Twitter) mark, a filled brand glyph like IconLinkedIn. IconX is the close cross. */
export function IconXLogo({ size = 20, className }: IconProps) {
  return (
    <svg width={size} height={size} viewBox="0 0 24 24" fill="currentColor" className={className}>
...
/** Two chain links: copy a page's address. */
...
export function IconDollarSign({ size = 20, className }: IconProps) {
  return (
    <svg width={size} height={size} viewBox="0 0 24 24" className={className} {...base}>
...
export function IconTrendingDown({ size = 20, className }: IconProps) {
  return (
    <svg width={size} height={size} viewBox="0 0 24 24" className={className} {...base}>
...
export function IconAward({ size = 20, className }: IconProps) {
  return (
    <svg width={size} height={size} viewBox="0 0 24 24" className={className} {...base}>
...
export function IconUserTie({ size = 20, className }: IconProps) {
  return (
    <svg width={size} height={size} viewBox="0 0 24 24" className={className} {...base}>
      <circle cx="12" cy="6" r="3.5" />
      <path d="M5.5 20.5a6.5 6.5 0 0 1 13 0" />
      <path d="M10.3 9.7 12 12l1.7-2.3" />
      <path d="M12 12v3.5" />
    </svg>
  );
}
