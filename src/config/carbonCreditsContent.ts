...
export const CARBON_CREDITS: {
  ...
  hero: {
    ...
    // No reduction is verified until a project is registered and audited, so the
    // hero says the reductions can be verified, not that they already are.
    subtitle:
      'Your solar system already saves you money by reducing your electricity bill. It also creates carbon reductions that can be verified and sold. We manage the certification, trading, and sale of your carbon credits, creating a new revenue stream from the same solar asset.',
  },
  ...
  becomes: {
    ...
    subtitle:
      'Every unit of clean electricity your solar system produces displaces electricity that would otherwise have been supplied by the national grid, avoiding carbon emissions in the process. Those avoided emissions can be independently measured, certified and sold as carbon credits, which gives you an additional revenue stream from the solar system you already own.',
    cards: [
      ...
      { icon: 'DollarSign', title: 'Your carbon credits are sold on your behalf', body: 'We market and sell your certified carbon credits to qualified buyers, manage the transaction from start to finish, and distribute the proceeds to you. Your existing solar system becomes an ongoing source of additional revenue.' },
    ],
  },
  ...
  faq: {
    ...
    items: [
      ...
      { question: 'Do I still own my solar system?', answer: 'Yes. You retain full ownership of your system and continue to operate it exactly as you do today. We only manage the certification and sale of the carbon reductions it produces.' },
      ...
      { question: 'What does the service cost?', answer: 'There’s no upfront cost to assess and register your system. We’re paid from a share of the credit revenue generated, so our incentives are aligned with yours. We only earn when you do.' },
      { question: 'Is there a minimum system size?', answer: 'Larger systems generate more credits and are the most economical to register, but we assess each system individually. Check your eligibility and we’ll tell you whether yours qualifies.' },
      { question: 'How long before I receive my first payment?', answer: `Onboarding and registration typically take ${claimValue('carbon-onboarding-time')}, after which monitoring runs continuously and credits are issued and sold on a scheduled basis.` },
      { question: 'What happens if carbon prices change?', answer: 'Carbon prices move with the market, which is why we show revenue as a range rather than a fixed figure. We actively manage the timing and placement of sales to protect your returns.' },
