...
export const EV_FLEETS: {
  ...
  faq: {
    ...
    items: [
      ...
      { question: 'Do we need upfront capital to get started?', answer: 'No. You can choose the commercial model that best suits your business—from a fully managed Fleet-as-a-Service subscription with little to no upfront capital, to outright purchase using your own capital or third-party financing.' },
